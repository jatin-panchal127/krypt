		...
		<div className='flex w-full justify-center items-center'>
			<div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
				<div className='flex flex-1 flex-col justify-start mf:mr-10'>
					<h1 className='text-3xl sm:text-5xl text-white text-gradient py-1'> Send Crypto <br /> Across the Globe</h1>
					...
					<div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
						...
						<div className='h-[1px] w-full bg-gray-400 my-2 ' />
						{
							isLoading ? (
								...
								<button type='button' onClick={handleSubmit} className='text-white w-full mt-5 border-[1px] p-2 border-[#3d4f7c] rounded-full cursor-pointer'>
									Send Now
								</button>
							)
						}
